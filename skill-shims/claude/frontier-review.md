...
`.agents/skills/frontier-review/SKILL.md` (the Claude-lane sections). One canonical body shared by
both lanes — do not duplicate its content here, and do not infer the cap or the packet rules from
this file.
